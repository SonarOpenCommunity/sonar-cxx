    ...
    var parser = new StaxParser(new StaxParser.XmlStreamHandler() {
      ...
      public void stream(SMHierarchicCursor rootCursor) throws XMLStreamException {
        try {
          ...
          CxxUtils.validateRecovery(new EmptyReportException("Cannot read PClint report", eofExc), context.config());
        }
        ...
        try {
          ...
          CxxUtils.validateRecovery(new InvalidReportException("Lint report" + report + "cannot be parsed", e), context.config());

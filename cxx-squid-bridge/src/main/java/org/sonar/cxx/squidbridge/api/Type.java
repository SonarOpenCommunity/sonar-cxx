...
public interface Type {
     ...
     * classes). In the initial implementation, this falls back to exact
     * matching ({@link #is(String)}). As the semantic analysis engine matures,
     * full subtype checking can be implemented.
     *
     ...
     *
     * <p>
     * This implementation stores a fully qualified name string and performs

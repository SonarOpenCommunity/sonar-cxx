...
public interface Symbol {
    ...
    /**
     * @return true if this symbol represents a type (class, struct, union,
     * enum, typedef)
     */
    ...
    /**
     * @return true if this symbol is unknown (no semantic information
     * available)
     */
    boolean isUnknown();
    ...
    interface TypeSymbol extends Symbol {
        ...
        /**
         * An instance of {@link TypeSymbol} representing an unknown type
         * symbol.
         */
        ...
        /**
         * List of symbols defined by this type (member variables, methods,
         * nested types).
         *
         * <p>
    ...
    interface FunctionSymbol extends Symbol {
         ...
         *
         * <p>
         * This provides type information for the function's return value,
         ...
         * parameter symbol. Useful for matching function signatures in
         * detection rules.
         *
         * @return list of parameter types in declaration order, empty list if
         * no parameters
         */

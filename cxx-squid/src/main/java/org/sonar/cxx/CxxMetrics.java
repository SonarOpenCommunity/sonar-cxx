...
// Introduce metric keys for sensors - number of issues per file / per module
  public static final String CLANG_SA_SENSOR_ISSUES_KEY = "CXX-ClangSA";
  public static final Metric<Integer> CLANG_SA_SENSOR_ISSUES = new Metric.Builder(CLANG_SA_SENSOR_ISSUES_KEY,
                                                                                  "ClangSA issues",
                                                                                  Metric.ValueType.INT)
    .setDescription("ClangSA issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String CLANG_TIDY_SENSOR_ISSUES_KEY = "CXX-Clang-Tidy";
  public static final Metric<Integer> CLANG_TIDY_SENSOR_ISSUES = new Metric.Builder(CLANG_TIDY_SENSOR_ISSUES_KEY,
                                                                                    "ClangTidy issues",
                                                                                    Metric.ValueType.INT)
    .setDescription("ClangTidy issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String VC_SENSOR_ISSUES_KEY = "CXX-Compiler-VC";
  public static final Metric<Integer> VC_SENSOR_ISSUES = new Metric.Builder(VC_SENSOR_ISSUES_KEY,
                                                                            "VC compiler issues",
                                                                            Metric.ValueType.INT)
    .setDescription("VC compiler issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String GCC_SENSOR_ISSUES_KEY = "CXX-Compiler-GCC";
  public static final Metric<Integer> GCC_SENSOR_ISSUES = new Metric.Builder(GCC_SENSOR_ISSUES_KEY,
                                                                             "GCC compiler issues",
                                                                             Metric.ValueType.INT)
    .setDescription("GCC compiler issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String CPPCHECK_SENSOR_ISSUES_KEY = "CXX-CppCheck";
  public static final Metric<Integer> CPPCHECK_SENSOR_ISSUES = new Metric.Builder(CPPCHECK_SENSOR_ISSUES_KEY,
                                                                                  "CppCheck issues",
                                                                                  Metric.ValueType.INT)
    .setDescription("CppCheck issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String DRMEMORY_SENSOR_ISSUES_KEY = "CXX-DrMemory";
  public static final Metric<Integer> DRMEMORY_SENSOR_ISSUES = new Metric.Builder(DRMEMORY_SENSOR_ISSUES_KEY,
                                                                                  "DrMemory issues",
                                                                                  Metric.ValueType.INT)
    .setDescription("DrMemory issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String OTHER_SENSOR_ISSUES_KEY = "CXX-other";
  public static final Metric<Integer> OTHER_SENSOR_ISSUES = new Metric.Builder(OTHER_SENSOR_ISSUES_KEY,
                                                                               "Other tools issues",
                                                                               Metric.ValueType.INT)
    .setDescription("Other tools issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String PCLINT_SENSOR_ISSUES_KEY = "CXX-PC-Lint";
  public static final Metric<Integer> PCLINT_SENSOR_ISSUES = new Metric.Builder(PCLINT_SENSOR_ISSUES_KEY,
                                                                                "PC-Lint issues",
                                                                                Metric.ValueType.INT)
    .setDescription("PC-Lint issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String RATS_SENSOR_ISSUES_KEY = "CXX-Rats";
  public static final Metric<Integer> RATS_SENSOR_ISSUES = new Metric.Builder(RATS_SENSOR_ISSUES_KEY,
                                                                              "Rats issues",
                                                                              Metric.ValueType.INT)
    .setDescription("Rats issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String SQUID_SENSOR_ISSUES_KEY = "CXX-Squid";
  public static final Metric<Integer> SQUID_SENSOR_ISSUES = new Metric.Builder(SQUID_SENSOR_ISSUES_KEY,
                                                                               "Squid issues",
                                                                               Metric.ValueType.INT)
    .setDescription("Squid issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String VALGRIND_SENSOR_KEY = "CXX-Valgrind";
  public static final Metric<Integer> VALGRIND_SENSOR = new Metric.Builder(VALGRIND_SENSOR_KEY,
                                                                           "Valgrind issues",
                                                                           Metric.ValueType.INT)
    .setDescription("Valgrind issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)
  ...
  public static final String VERAXX_SENSOR_KEY = "CXX-Vera++";
  public static final Metric<Integer> VERAXX_SENSOR = new Metric.Builder(VERAXX_SENSOR_KEY,
                                                                         "Vera issues",
                                                                         Metric.ValueType.INT)
    .setDescription("Vera issues")
    .setDirection(Metric.DIRECTION_WORST)
    .setDomain("C++")
    .setBestValue(0.0)
    .setOptimizedBestValue(Boolean.TRUE)

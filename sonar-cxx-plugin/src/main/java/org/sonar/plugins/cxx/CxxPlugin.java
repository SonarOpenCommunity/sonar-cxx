...
public final class CxxPlugin implements Plugin {
  ...
  private static List<PropertyDefinition> codeAnalysisProperties() {
    ...
    return new ArrayList<>(Arrays.asList(
      PropertyDefinition.builder(LANG_PROP_PREFIX + CxxCppCheckSensor.REPORT_PATH_KEY)
      ...
      .index(10)
      .build(),
      PropertyDefinition.builder(LANG_PROP_PREFIX + CxxExternalRulesSensor.REPORT_PATH_KEY)
      ...
      .index(11)
      .build(),
      PropertyDefinition.builder(LANG_PROP_PREFIX + CxxExternalRuleRepository.RULES_KEY)
      .name("External rules")

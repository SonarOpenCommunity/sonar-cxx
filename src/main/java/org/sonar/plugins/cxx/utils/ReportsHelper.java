...
public abstract class ReportsHelper {
  ...
  public File[] getReports(MavenProject mavenProject, File dir) {
    ...
    MavenPlugin plugin = MavenPlugin.getPlugin(mavenProject, getGroupId(), getArtifactId());
    ...
    getLogger().info(getGroupId() + " " + getArtifactId() + " includes value = {}", includes);
    getLogger().info(getGroupId() + " " + getArtifactId() + " excludes value = {}", excludes);

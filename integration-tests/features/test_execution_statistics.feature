Feature: Providing test execution numbers
  ...
  Scenario Outline: Importing unchanged test reports generated by googletest
      ...
      Examples:
      # the order of metrics: tests, test_failures, test_errors, skipped_tests,
      #                       test_success_density, test_execution time
      #
      | reportpath                | values                             |
      | gtest.xml                 | 3, 2, 0, 1, 33.3, 50               | 'locatable' testscases
      | gtest_without_fixture.xml | None, None, None, None, None, None | 'unlocatable' testcases

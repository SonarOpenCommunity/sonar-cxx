...
| **Travis CI**<br>(Linux Build and Integration Tests) | [![Build Status](https://www.travis-ci.com/SonarOpenCommunity/sonar-cxx.svg?branch=master)](https://www.travis-ci.com/SonarOpenCommunity/sonar-cxx) |

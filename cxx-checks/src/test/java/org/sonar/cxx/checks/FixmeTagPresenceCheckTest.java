...
public class FixmeTagPresenceCheckTest {
  ...
  public void detected() throws UnsupportedEncodingException, IOException {
    String fileName = "src/test/resources/checks/FixmeTagPresenceCheck.cc";
    ...
    SourceFile file = CxxAstScanner.scanSingleFile(cxxFile, sensorContext, new FixmeTagPresenceCheck());    

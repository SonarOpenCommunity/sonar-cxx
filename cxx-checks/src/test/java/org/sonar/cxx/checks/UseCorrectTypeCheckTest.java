...
public class UseCorrectTypeCheckTest {
  ...
  public void detected() throws UnsupportedEncodingException, IOException {
    String fileName = "src/test/resources/checks/UseCorrectTypesCheck.cc";
    ...
    SourceFile file = CxxAstScanner.scanSingleFile(cxxFile, sensorContext, new UseCorrectTypeCheck()); 

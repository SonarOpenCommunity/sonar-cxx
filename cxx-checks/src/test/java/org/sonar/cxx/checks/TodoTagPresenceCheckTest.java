...
public class TodoTagPresenceCheckTest {
  ...
  public void detected() throws UnsupportedEncodingException, IOException {
    String fileName = "src/test/resources/checks/TodoTagPresenceCheck.cc";
    ...
    SourceFile file = CxxAstScanner.scanSingleFile(cxxFile, sensorContext, new TodoTagPresenceCheck()); 

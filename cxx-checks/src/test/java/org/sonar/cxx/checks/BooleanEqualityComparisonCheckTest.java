...
public class BooleanEqualityComparisonCheckTest {
  ...
  public void detected() throws UnsupportedEncodingException, IOException {
    ...
    String fileName = "src/test/resources/checks/BooleanEqualityComparisonCheck.cc";
    ...
    SourceFile file = CxxAstScanner.scanSingleFile(cxxFile, sensorContext, new BooleanEqualityComparisonCheck());

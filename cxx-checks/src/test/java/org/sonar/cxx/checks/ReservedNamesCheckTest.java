...
public class ReservedNamesCheckTest {
  ...
  public void detected() throws UnsupportedEncodingException, IOException {
    String fileName = "src/test/resources/checks/ReservedNamesCheck.cc";
    ...
    SourceFile file = CxxAstScanner.scanSingleFile(cxxFile, sensorContext, new ReservedNamesCheck()); 

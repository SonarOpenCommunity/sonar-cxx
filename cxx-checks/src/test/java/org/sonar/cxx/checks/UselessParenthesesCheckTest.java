...
public class UselessParenthesesCheckTest {
  ...
  public void detected() throws IOException {
    String fileName = "src/test/resources/checks/UselessParenthesesCheck.cc";
    ...
    SourceFile file = CxxAstScanner.scanSingleFile(cxxFile, sensorContext, new UselessParenthesesCheck()); 

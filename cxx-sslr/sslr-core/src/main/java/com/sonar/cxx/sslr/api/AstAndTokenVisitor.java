...
/**
 * The AstVisitor allows to visit some desired AstNode. The AstAndTokenVisitor extends this first interface to add a new
 * feature : being visited for each Token generated by the Lexer.
 *
 */
